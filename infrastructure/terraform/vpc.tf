...
# Private route table has no default route — RDS and ElastiCache have no internet access.
# ECS tasks moved to public subnets and reach the internet via the Internet Gateway directly.
